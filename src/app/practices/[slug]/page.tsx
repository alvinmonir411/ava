...
export default async function IndividualPracticePage({ params }: Props) {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-8 space-y-10">
              ...
              <div className="relative h-64 sm:h-80 w-full rounded-lg overflow-hidden border border-[#c6a052]/40 bg-[#1a2332] shadow-sm">
                <Image
                ...
                <div className="absolute bottom-4 left-4 right-4 p-3.5 rounded bg-[#1a2332]/90 border border-[#c6a052]/40 text-[#faf9f6] flex items-center justify-between">
                  <div>
              ...
              <div className="bg-white p-6 sm:p-8 rounded-lg border border-[#e8e1d5] shadow-xs">
                <h2 className="font-serif text-2xl sm:text-3xl font-bold text-[#1a2332] mb-4">
                  Overview & Legal Representation
                </h2>
                <div className="prose text-[#374151] leading-relaxed space-y-4 text-sm sm:text-base font-normal">
              ...
              {practice.statutoryFramework && practice.statutoryFramework.length > 0 && (
                <div className="p-6 sm:p-8 rounded-lg bg-[#1a2332] text-[#faf9f6] border border-[#c6a052]/40 shadow-sm">
                  ...
                  <p className="text-xs text-[#faf9f6]/75 mb-5">
              ...
              <div className="p-6 sm:p-8 rounded-lg bg-white border border-[#e8e1d5] space-y-5 shadow-xs">
                <h3 className="font-serif text-2xl font-bold text-[#1a2332]">
                  What We Handle in This Practice Discipline
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  {practice.whatWeHandle.map((item, idx) => (
                    <div key={idx} className="flex items-start gap-2.5 bg-[#faf9f6] p-3.5 rounded border border-[#e8e1d5]">
                ...
                <div className="p-6 sm:p-8 rounded-lg bg-white border border-[#e8e1d5] shadow-xs space-y-5">
                  ...
                  <div className="space-y-3">
                    {practice.proceduralTimeline.map((item, tIdx) => (
                      <div
                        key={tIdx}
                        className="flex items-start gap-3.5 p-3.5 rounded bg-[#faf9f6] border border-[#e8e1d5]"
                      >
                        <div className="w-7 h-7 rounded bg-[#1a2332] text-[#dcc280] font-serif font-bold text-xs flex items-center justify-center shrink-0 border border-[#c6a052]/40">
                          {item.step || tIdx + 1}
                        </div>
                        <div className="flex-1 text-xs">
                          <div className="flex flex-wrap items-center justify-between gap-1 mb-1">
                            ...
                            {item.duration && (
                              <span className="text-[10px] font-semibold text-[#9d7835] bg-white px-2 py-0.5 rounded border border-gray-200">
                                ⏱ {item.duration}
                              </span>
                            )}
                          </div>
              ...
              {practice.faqs && practice.faqs.length > 0 && (
                <div className="p-6 sm:p-8 rounded-lg bg-white border border-[#e8e1d5] shadow-xs space-y-4">
                  <div className="flex items-center gap-2 text-[#9d7835] text-xs font-bold uppercase tracking-wider">
            ...
            <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-28">
              ...
              <div className="p-6 bg-white rounded-lg border border-[#c6a052]/40 shadow-xs space-y-3">
                ...
                <h4 className="font-serif text-lg font-bold text-[#1a2332]">
              ...
              <div className="p-5 bg-white rounded-lg border border-[#e8e1d5] space-y-3 shadow-xs">
                <h4 className="font-serif text-sm font-bold text-[#1a2332] uppercase tracking-wider border-b border-gray-100 pb-2">
                    ...
                    <li key={p.slug}>
                      <Link
                        ...
                        className={`block py-1 hover:text-[#9d7835] transition-colors line-clamp-1 ${
                          p.slug === practice.slug ? 'font-bold text-[#9d7835]' : 'text-[#4b5563]'
                        }`}
                      >
                        • {p.title}
                      </Link>
      ...
      <section id="consultation-box" className="py-20 bg-[#1a2332] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h3 className="font-serif text-2xl sm:text-3xl font-bold text-white mb-2">
              Book a Consultation on {practice.title}
            </h3>
            <p className="text-xs sm:text-sm text-[#faf9f6]/75">
