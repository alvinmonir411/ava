...
export default async function AboutPage() {
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="md:col-span-5 flex flex-col items-center">
              <div className="relative w-full max-w-[380px] p-2 bg-white border border-[#c6a052]/40 rounded-lg shadow-md mb-6">
                <div className="relative h-[440px] sm:h-[480px] w-full rounded overflow-hidden bg-[#1e0d33]/10">
                  <Image
                    src="/lawyer-hero.jpg"
                ...
                <div className="mt-3 text-center px-2 py-1">
                  <p className="font-serif text-base font-bold text-[#1e0d33]">
                    Low Wah Chin (Ava Rachel)
                    <span className="text-sm font-normal text-[#9d7835] ml-1.5">劉華晶</span>
                  </p>
                  <p className="text-xs text-[#594d63] font-medium mt-0.5">
              ...
              <div className="w-full max-w-[380px] bg-white p-5 rounded-lg border border-[#ebdff5] space-y-3 shadow-xs text-xs">
                <h4 className="font-serif font-bold text-[#1e0d33] uppercase tracking-wider border-b border-[#ebdff5] pb-2 flex items-center gap-2">
                  <GraduationCap className="w-4 h-4 text-[#c6a052]" />
                  <span>Academic Qualifications & Admissions</span>
                </h4>
                <ul className="space-y-2 text-[#594d63]">
            ...
            <div className="md:col-span-7 space-y-6">
              ...
              <div className="p-4 bg-white border-l-4 border-[#c6a052] rounded-r-md border border-[#ebdff5] text-xs sm:text-sm text-[#1e0d33] font-medium leading-relaxed shadow-xs">
              ...
              <div className="p-6 bg-[#180829] text-[#faf7fc] rounded-lg border border-[#c6a052]/40 shadow-sm space-y-2">
              ...
              <div className="pt-4 border-t border-[#ebdff5] flex flex-wrap gap-4">
                <Link
                  href="/our-team"
      ...
      <section className="py-20 bg-white text-[#1e0d33] border-b border-[#ebdff5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 bg-[#faf7fc] border border-[#ebdff5] rounded-lg hover:border-[#c6a052] transition-colors">
              <div className="w-10 h-10 rounded bg-white border border-[#c6a052]/40 flex items-center justify-center text-[#9d7835] mb-4">
                <Scale className="w-5 h-5" />
              </div>
              <h3 className="font-serif text-lg font-bold text-[#1e0d33] mb-2">
                1. Passion & Duty
              </h3>
      ...
      <section className="py-20 lg:py-24 bg-[#180829] text-[#faf7fc] border-b border-[#c6a052]/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs text-[#faf7fc]/85">
            <div className="p-6 border border-[#c6a052]/30 bg-[#120720]/80 rounded-lg">
