...
export default function PracticeAreasDark() {
  return (
    <section className="relative py-24 lg:py-32 bg-[#180829] text-[#faf7fc] overflow-hidden border-b border-[#c6a052]/30">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-[#120720]/90" />
      </div>

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Centered Heading + Subheading */}
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full border border-[#c6a052]/40 bg-[#1e0d33]/85 text-[#dcc280] text-xs font-bold uppercase tracking-[0.2em] mb-4">
          ...
          <p className="text-sm sm:text-base text-[#faf7fc]/80 font-light leading-relaxed">
          ...
          {PRACTICE_AREAS.map((area, idx) => {
            ...
            return (
              <Link
                ...
                className="group block p-5 sm:p-7 lg:p-8 rounded-none border border-[#c6a052]/40 bg-[#1e0d33]/40 hover:border-[#dcc280] hover:bg-[#2d144a]/60 transition-all duration-300"
              >
