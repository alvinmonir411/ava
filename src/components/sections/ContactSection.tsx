...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 lg:py-28 bg-[#FAF8F2] text-[#2B2D33] border-b border-[#E5DFD3]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="md:col-span-5 space-y-6">
            <div>
              <div className="inline-flex items-center gap-2 text-[#4B2A7B] text-xs font-bold uppercase tracking-[0.2em] mb-2">
                <ShieldCheck className="w-3.5 h-3.5 text-[#4B2A7B]" />
            ...
            <p className="text-sm sm:text-base text-[#2B2D33]/80 leading-relaxed">
            ...
            <div className="p-6 bg-white rounded-xl border border-[#E5DFD3] space-y-4 text-xs sm:text-sm shadow-xs">
              <div className="flex items-start gap-3">
                <MapPin className="w-4 h-4 text-[#4B2A7B] mt-0.5 shrink-0" />
                <div>
                  <strong className="text-[#2B2D33] block">Main Chambers</strong>
                  <span className="text-[#2B2D33]/70 leading-relaxed block">
              ...
              <div className="flex items-start gap-3">
                <Phone className="w-4 h-4 text-[#4B2A7B] mt-0.5 shrink-0" />
                <div>
                  <strong className="text-[#2B2D33] block">Telephone</strong>
                  <a href="tel:+60175483157" className="text-[#4B2A7B] hover:underline font-semibold">
                    +60 17-548 3157
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                <Mail className="w-4 h-4 text-[#4B2A7B] mt-0.5 shrink-0" />
                <div>
                  <strong className="text-[#2B2D33] block">Email Inquiries</strong>
                  <a href="mailto:lwclegal5@gmail.com" className="text-[#4B2A7B] hover:underline font-semibold">
                    lwclegal5@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                <Clock className="w-4 h-4 text-[#4B2A7B] mt-0.5 shrink-0" />
                <div>
                  <strong className="text-[#2B2D33] block">Consultation Hours</strong>
                  <span className="text-[#2B2D33]/70">Monday – Friday: 9:00 AM – 5:30 PM</span>
                </div>
              </div>
            </div>
          ...
          <div className="md:col-span-7 bg-white p-7 sm:p-9 rounded-xl border border-[#E5DFD3] shadow-sm">
            <h3 className="font-serif text-2xl font-bold text-[#2B2D33] mb-2">
              Schedule a Consultation
            </h3>
            <p className="text-xs sm:text-sm text-[#2B2D33]/70 mb-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="firstName" className="block text-xs font-bold uppercase tracking-wider text-[#2B2D33] mb-1.5">
                    First Name <span className="text-[#4B2A7B]">*</span>
                  </label>
                  <input
                    type="text"
                    id="firstName"
                    ...
                    className="w-full px-3.5 py-2.5 rounded-lg border border-[#E5DFD3] text-sm text-[#2B2D33] focus:outline-none focus:border-[#4B2A7B] focus:ring-2 focus:ring-[#4B2A7B] transition-colors bg-white"
                  />
                ...
                <div>
                  <label htmlFor="lastName" className="block text-xs font-bold uppercase tracking-wider text-[#2B2D33] mb-1.5">
                    Last Name <span className="text-[#4B2A7B]">*</span>
                  </label>
                  <input
                    type="text"
                    id="lastName"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="email" className="block text-xs font-bold uppercase tracking-wider text-[#2B2D33] mb-1.5">
                    Email Address <span className="text-[#4B2A7B]">*</span>
                  </label>
                  <input
                    type="email"
                    id="email"
                ...
                <div>
                  <label htmlFor="phone" className="block text-xs font-bold uppercase tracking-wider text-[#2B2D33] mb-1.5">
                    Phone / WhatsApp <span className="text-[#4B2A7B]">*</span>
                  </label>
                  <input
                    type="tel"
                    id="phone"
              ...
              <div>
                <label htmlFor="practiceArea" className="block text-xs font-bold uppercase tracking-wider text-[#2B2D33] mb-1.5">
                  Legal Matter Category <span className="text-[#4B2A7B]">*</span>
                </label>
                <select
                  id="practiceArea"
                  name="practiceArea"
              ...
              <div>
                <label htmlFor="message" className="block text-xs font-bold uppercase tracking-wider text-[#2B2D33] mb-1.5">
                  Summary of Legal Matter <span className="text-[#4B2A7B]">*</span>
                </label>
                <textarea
                  id="message"
                  name="message"
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={isPending}
                  className="btn-gradient-royal w-full py-3.5 rounded-lg text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer shadow-md disabled:opacity-50"
                >
                  {isPending ? (
