    ...
    <section className="py-20 lg:py-28 bg-[#faf9f6] text-[#231f20] border-b border-[#e5e7eb]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="md:col-span-5 bg-white p-6 sm:p-8 rounded-lg border border-[#e8e1d5] shadow-sm space-y-6">
            ...
            <div className="space-y-4 text-xs sm:text-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-[#1a2332] block">Operating Hours</strong>
                  <span className="text-[#4b5563]">Monday to Friday · 9:00am – 5:30pm</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-[#1a2332] block">Direct Telephone</strong>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-[#1a2332] block">Official Email</strong>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-[#1a2332] block">Full Chambers Address</strong>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-[#1a2332] block">Bar Membership & Jurisdiction</strong>
                  <span className="text-[#4b5563]">High Court of Malaya • Bar No. BC/L/2019</span>
                </div>
              </div>
            </div>
            ...
            <div className="pt-2 border-t border-gray-100">
              <Link
                href="/contact"
                className="text-xs font-bold text-[#9d7835] hover:text-[#1a2332] inline-flex items-center gap-1.5"
              >
          ...
          <div className="md:col-span-7 space-y-8">
            ...
            <div className="space-y-4 text-sm sm:text-base text-[#374151] leading-relaxed">
              ...
              <div>
                <Link
                  href="/about"
                  className="font-serif text-sm font-bold text-[#9d7835] hover:text-[#1a2332] inline-flex items-center gap-1.5 group"
                >
            ...
            <div className="pt-6 border-t border-gray-200 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <Link
                  ...
                  className="p-4 bg-white rounded-lg border border-[#e8e1d5] hover:border-[#c6a052] transition-colors group block"
                >
                  <span className="text-[10px] font-bold uppercase tracking-wider text-[#9d7835] block mb-1">
                    Industry Review
                  </span>
                  <h5 className="font-serif text-sm font-bold text-[#1a2332] group-hover:text-[#9d7835] transition-colors leading-snug">
