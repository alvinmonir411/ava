...
export default function FounderPhilosophy() {
  return (
    <AuroraBackground
      intensity="subtle"
      showGrid={false}
      className="py-16 sm:py-24 bg-[#FAF8F2] text-[#2B2D33] border-t border-[#E5DFD3]"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <ScrollReveal animation="fade-up" duration={700} className="lg:col-span-5">
            <AuroraGlow glowColor="gold" rounded="rounded-2xl">
              <div className="relative rounded-2xl overflow-hidden border-2 border-[#4B2A7B] shadow-xl bg-white p-2">
                <div className="relative h-[420px] sm:h-[480px] w-full rounded-xl overflow-hidden bg-[#FAF8F2]">
                  <Image
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#2B2D33]/50 via-transparent to-transparent" />
                </div>

                {/* Bottom Accreditation Badge */}
                <div className="mt-2 p-4 rounded-xl bg-white border border-[#E5DFD3] text-[#2B2D33] shadow-xs">
          ...
          <ScrollReveal animation="fade-up" delay={200} duration={700} className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-[#D8C7F0] text-[#4B2A7B] text-xs font-bold uppercase tracking-wider shadow-xs">
              <Scale className="w-3.5 h-3.5 text-[#4B2A7B]" />
              <span>Founder Insight & Judicial Philosophy</span>
            </div>

            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-tight text-[#2B2D33]">
              &ldquo;Advocacy is not merely argument—it is the art of deliberate, principled clarity.&rdquo;
            </h2>

            <p className="text-sm sm:text-base text-[#2B2D33]/85 leading-relaxed font-light">
              Admitted to the Malaysian Bar on <strong>11th November 2011</strong>, principal counsel <strong>Low Wah Chin (Ava Rachel) 劉華晶</strong> synthesizes classical British Barrister trial discipline, practising since 11 November 2011 in Malaysian corporate and litigation law from leading national benchmark practices (including <em>Shook Lin & Bok</em>, <em>Azim, Tunku Farik & Wong</em>, <em>Murali B. Pillai & Associates</em>, and ~9 months as In-House Legal Counsel at <em>KNM Group Berhad</em>).
            </p>

            {/* 3 Pillar Statements */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="p-4 rounded-xl bg-white border border-[#E5DFD3] shadow-xs">
                <div className="flex items-center gap-2 text-xs font-bold text-[#2B2D33] uppercase tracking-wider mb-1.5">
                  <Shield className="w-4 h-4 text-[#4B2A7B]" />
                  <span>Ethical Trial Craft</span>
                </div>
                <p className="text-xs text-[#2B2D33]/75 leading-relaxed font-light">
              ...
              <div className="p-4 rounded-xl bg-white border border-[#E5DFD3] shadow-xs">
                <div className="flex items-center gap-2 text-xs font-bold text-[#2B2D33] uppercase tracking-wider mb-1.5">
                  <Globe2 className="w-4 h-4 text-[#4B2A7B]" />
            ...
            <div className="p-4 rounded-xl bg-white border-l-4 border-[#4B2A7B] border border-[#E5DFD3] text-xs text-[#2B2D33]/90 space-y-1.5 shadow-sm">
              <p className="font-serif italic text-sm text-[#4B2A7B]">
                &ldquo;以专业之智，行正义之道；以严谨之心，护当事人之权益。&rdquo;
              </p>
              <p className="text-[11.5px] text-[#2B2D33]/75 font-light">
