...
export default function TrustedMalaysiaBadge({ className = '', size = 'md' }: TrustedMalaysiaBadgeProps) {
  ...
  return (
    <div className={`relative flex items-center justify-center ${className}`}>
      {/* Ambient Glow */}
      <div 
        className="absolute inset-0 bg-[#4B2A7B]/15 rounded-full blur-2xl transform scale-90 pointer-events-none" 
        aria-hidden="true" 
      />

      <svg
        viewBox="0 0 400 400"
        className={`w-full h-auto ${sizeClasses[size]} drop-shadow-[0_15px_35px_rgba(43,45,51,0.35)] select-none relative z-10 transition-transform duration-500 hover:scale-[1.02]`}
      ...
      >
        ...
        <g transform="translate(90, 200)">
          <circle cx="0" cy="0" r="19" fill="url(#green-grad)" stroke="#2B2D33" strokeWidth="4.5" />
          <path
        ...
        <g stroke="#2B2D33" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" fill="none">
          {/* Ground Baseline */}
          ...
          <circle cx="184" cy="132" r="3" fill="#2B2D33" stroke="none" />
          {/* Stepped Roof */}
          ...
          <circle cx="216" cy="132" r="3" fill="#2B2D33" stroke="none" />
          {/* Stepped Roof */}
